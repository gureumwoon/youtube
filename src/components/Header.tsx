...
export default function Header() {
    return (
        <header className='w-full flex justify-between items-center px-4 py-3'>
            ...
            <form className='w-full flex justify-center flex-grow'>
                <input type='text' placeholder='검색' className='w-3/12 min-w-96 py-2 px-3 rounded-tl-full rounded-bl-full border border-borderCorlor bg-mainColor z-10' />
